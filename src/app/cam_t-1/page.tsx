        ...
        <div className="full_page">
          ...
          <div className="project_top_section">
            <div className="project_grid">
                ...
                <div className="project_item reveal">
                  <div className="image"><img src="/WT_portofolio/cam.png" alt="Portable Climbing Wall" /></div>
                </div>
            ...
            <div className="project_images_col reveal delay-1">
              <img src="/WT_portofolio/cam_illu(1).png" alt="Camera illustration 1" />
              <img src="/WT_portofolio/cam_illu(2).png" alt="Camera illustration 2" />
            </div>
