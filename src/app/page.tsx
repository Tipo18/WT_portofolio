      ...
      <div className="featured_section">
        <div className="featured_grid">
            <a href="/cam_t-1" className="featured_item reveal delay-1">
              <div className="image"><img src="/WT_portofolio/cam.png" alt="Camera T-1" /></div>
              <div className="texte">
          ...
          <a href="/climbing_wall"className="featured_item reveal delay-2">
            <div className="image"><img src="/WT_portofolio/mur.png" alt="Portable Climbing Wall" /></div>
            <div className="texte">
          ...
          <a href="/surf_shape"className="featured_item reveal delay-3">
            <div className="image"><img src="/WT_portofolio/surf.png" alt="Shaping a Surfboard" /></div>
            <div className="texte">
        ...
        <div className="project reveal">
          <a href="/satelite_catching"className="image">
            <img src="/WT_portofolio/NOAA.png" alt="satelite_catching" />
          </a>
        ...
        <div className="project reveal">
          <a href="/photography" className="image">
            <img src="/WT_portofolio/photo.png" alt="photography" />
          </a>
        ...
        <div className="project reveal">
          <a href="/CNN_echocard" className="image">
            <img src="/WT_portofolio/CNN.png" alt="CNN_echocard" />
          </a>
        ...
        <div className="project reveal">
          <a href="/elec_motor" className="image">
            <img src="/WT_portofolio/motor.png" alt="elec_motor" />
          </a>
