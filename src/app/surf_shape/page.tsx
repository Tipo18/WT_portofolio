        ...
        <div className="full_page">
          ...
          <div className="project_top_section">
            <div className="project_grid">
                ...
                <div className="project_item reveal">
                  <div className="image"><img src="/WT_portofolio/surf_illu(1).gif" alt="Shapping a surfboard" /></div>
                </div>
          ...
          <div className="project_images_row_surf reveal delay-1">
            <img src="/WT_portofolio/surf_illu(2).png" alt="Camera illustration 1" />
            <div className="video-wrapper">
            <video controls preload="none" aria-label="Video player">
              <source src="/WT_portofolio/surf_illu(3).mov" type="video/quicktime" />
